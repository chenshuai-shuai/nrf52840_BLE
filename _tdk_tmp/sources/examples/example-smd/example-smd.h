 ...
 * ________________________________________________________________________________________________________
 */
#ifndef _EXAMPLE_SMD_H_
#define _EXAMPLE_SMD_H_
...
/**
 * \brief This function configures the device in order to output SMD.
 *
 * Then function sets full scale range and frequency for accel and it 
 * starts accel and SMD in the requested power mode with the requested configuration.
 *
