 ...
 * Use type ICM426XX_APEX_CONFIG4_R2W_SLEEP_TIME_OUT_t to define the time out for a sleep detection.
 ...
 * Use type ICM426XX_APEX_CONFIG5_R2W_MOUNTING_MATRIX_t to define mounting matrix, chip to device frame.
 * These types are defined in Icm426xxDefs.h.
 */
 ...
 * Use type ICM426XX_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_t to define the detection window for a sleep gesture detection.
 * These types are defined in Icm426xxDefs.h.
 */
#define ICM_R2W_SLEEP_GEST_DELAY ICM426XX_APEX_CONFIG6_R2W_SLEEP_GEST_DELAY_0_96S

/*
 * Raise to wake power save mode
 * Use type ICM426XX_APEX_CONFIG0_DMP_POWER_SAVE_t to define raise to wake power save mode.
 * These types are defined in Icm426xxDefs.h.
 */
#define ICM_R2W_POWER_SAVE_MODE ICM426XX_APEX_CONFIG0_DMP_POWER_SAVE_EN
...
int main(void)
{
	...
	/* Configure Icm426xx */
	rc = ConfigureInvDevice(ICM_R2W_SLEEP_TIME, ICM_R2W_MOUNTING_MATRIX, ICM_R2W_SLEEP_GEST_DELAY,
	                        ICM_R2W_POWER_SAVE_MODE);
...
static void SetupMCUHardware(struct inv_icm426xx_serif *icm_serif)
{
	...
	INV_MSG(INV_MSG_LEVEL_INFO, "#   Example R2W   #");
	INV_MSG(INV_MSG_LEVEL_INFO, "###################");
