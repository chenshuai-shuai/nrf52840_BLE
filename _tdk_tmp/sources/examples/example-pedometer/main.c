...
int main(void)
{
	...
	/* Configure Icm426xx */
	rc = ConfigureInvDevice(ICM_PEDOMETER_FREQUENCY_MODE, ICM_PEDOMETER_POWER_SAVE_MODE,
	                        ICM_PEDOMETER_VALID_STEP_THRESHOLD,
	                        ICM_PEDOMETER_STEP_COUNTER_THRESHOLD, ICM_PEDOMETER_NON_WALK_DURATION,
	                        ICM_PEDOMETER_STEP_DETECTOR_THRESHOLD, ICM_PEDOMETER_SENSITIVITY_MODE);
