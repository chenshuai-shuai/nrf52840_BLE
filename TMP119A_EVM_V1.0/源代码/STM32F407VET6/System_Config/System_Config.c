...
* 淘宝ID号 : eysmcu
* 注意事项 ：该程序为ALIENTEK STM32开发板例程！！！
***********************************************************************/

#include "system_Config.h"										//系统配置文件

/**********************************************************************
* 名称 : MY_NVIC_SetVectorTable(u32 NVIC_VectTab,u32 Offset)
* 功能 : 设置向量表偏移地址
* 输入 : NVIC_VectTab:基址,Offset:偏移量	
* 输出 ：无
* 说明 : 无
***********************************************************************/	 
...
/**********************************************************************
* 名称 : MY_NVIC_PriorityGroupConfig(u8 NVIC_Group)	 
* 功能 : 设置NVIC分组
* 输入 : NVIC_Group:NVIC分组 0~4 总共5组 		
* 输出 ：无
* 说明 : 无
***********************************************************************/		   
...
/**********************************************************************
* 名称 : MY_NVIC_Init(u8 NVIC_PreemptionPriority,u8 NVIC_SubPriority,u8 NVIC_Channel,u8 NVIC_Group)	 	 
* 功能 : 设置NVIC
...
/**********************************************************************
* 名称 : Ex_NVIC_Config(u8 GPIOx,u8 BITx,u8 TRIM)  	 
* 功能 : 外部中断配置函数
* 输入 : 只针对GPIOA~I;不包括PVD,RTC,USB_OTG,USB_HS,以太网唤醒等
		 参数:
		 GPIOx:0~8,代表GPIOA~I
		 BITx:需要使能的位;
...
/**********************************************************************
* 名称 : GPIO_AF_Set(GPIO_TypeDef* GPIOx,u8 BITx,u8 AFx)  	 
* 功能 : GPIO复用设置
* 输入 : GPIOx:GPIOA~GPIOI.
		 BITx:0~15,代表IO引脚编号.
		 AFx:0~15,代表AF0~AF15.
...
/**********************************************************************
* 名称 : GPIO_Set(GPIO_TypeDef* GPIOx,u32 BITx,u32 MODE,u32 OTYPE,u32 OSPEED,u32 PUPD) 	 
* 功能 : GPIO通用设置 
* 输入 : GPIOx:GPIOA~GPIOI.
...
* 输出 ：无
* 说明 : 注意:在输入模式(普通输入/模拟输入)下,OTYPE和OSPEED参数无效!!
***********************************************************************/
...
/**********************************************************************
* 名称 : INTX_DISABLE(void) 	 
* 功能 : 关闭所有中断(但是不包括fault和NMI中断)
* 输入 : 无
* 输出 ：无
* 说明 : 无
***********************************************************************/
...
/**********************************************************************
* 名称 : Sys_Clock_Set(u32 plln,u32 pllm,u32 pllp,u32 pllq)
* 功能 : 时钟设置函数  
* 输入 : Fvco=Fs*(plln/pllm);
...
/**********************************************************************
* 名称 : Stm32_Clock_Init(u32 plln,u32 pllm,u32 pllp,u32 pllq)
* 功能 : 系统时钟初始化函数
* 输入 : plln:主PLL倍频系数(PLL倍频),取值范围:64~432.
		 pllm:主PLL和音频PLL分频系数(PLL之前的分频),取值范围:2~63.
		 pllp:系统时钟的主PLL分频系数(PLL之后的分频),取值范围:2,4,6,8.(仅限这4个值!)
		 pllq:USB/SDIO/随机数产生器等的主PLL分频系数(PLL之后的分频),取值范围:2~15.
* 输出 ：无
