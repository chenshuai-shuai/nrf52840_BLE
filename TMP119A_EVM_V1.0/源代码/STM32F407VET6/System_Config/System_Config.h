...
#include "stm32f4xx.h" 									//STMF4X头文件

/*****************************相关定义*********************************/
//1.OS支持定义,0 -- 不支持OS，1 -- 支持OS

#define SYSTEM_SUPPORT_OS		0						//定义系统文件夹是否支持OS

//2.位带操作,实现51类似的GPIO控制功能,具体实现思想,参考<<CM3权威指南>>第五章(87页~92页).
//  M4同M3类似,只是寄存器地址变了.以下为IO口操作宏定义
...
extern u8 Sys_Clock_Set(u32 plln,u32 pllm,u32 pllp,u32 pllq);				//系统时钟设置
...
extern void GPIO_AF_Set(GPIO_TypeDef* GPIOx,u8 BITx,u8 AFx);				//GPIO复用功能设置
extern void GPIO_Set(GPIO_TypeDef* GPIOx,u32 BITx,u32 MODE,u32 OTYPE,u32 OSPEED,u32 PUPD);				//GPIO设置函数  
